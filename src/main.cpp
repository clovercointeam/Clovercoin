...
int64 nChainStartTime = 1399550644;
...
static const int CUTOFF_HEIGHT = 10000;	// Height at the end of 7 day
...
const int YEARLY_BLOCKCOUNT = 525600;	// 365 * 2880
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Clovercoin
    bool fStrictPayToScriptHash = true; // Always active in Clovercoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("c7a0c27158f9868c2d76f69c4986b9198170de1f2f82e434a5815fd1a7a33ee1"));
